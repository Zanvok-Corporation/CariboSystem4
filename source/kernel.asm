...
; =====================================================================
	...
	%DEFINE CARIBO_VER '4.7.0'	; OS version number
	%DEFINE CARIBO_API_VER 18	; API version for programs to check
...
os_main:
	...
	mov es, ax			; segments ever again, as CariboSystem and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to CariboSystem', 0
	os_version_msg		db 'Version ', CARIBO_VER, 0

	dialog_string_1		db 'Thanks for trying out CariboSystem!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute Flix kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of CariboSystem, and', 0
