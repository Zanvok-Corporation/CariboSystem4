; =====================================================================
; The CariboSystem Bootloader
; Copyright (C) 2018 - 2022 Zanvok Corporation -- see doc/LICENSE.TXT
;
; It scans the FAT12
; floppy for KERNEL.BIN (the Flix kernel), loads it and executes it.
...
VolumeLabel		db "CARIBOSYSTEM     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; Flix kernel filename
