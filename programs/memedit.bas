rem Memory Manipulator (MEMEDIT.BAS), version 5.0.2
rem An advanced memory modification tool for CariboSystem
rem Copyright (C) Zanvok Corporation 2022

rem Requires the GAU++ library, version 4.0.0 minimum
include "gaupp.bas"
...
init:
  ...
  $5 = "              About"
       $6 = "Memory Manipulator, version 5.0.2|"
