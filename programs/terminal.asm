; ------------------------------------------------------------------
; Minicom-like program for CariboSystem
; ------------------------------------------------------------------
...
;
; Connect the serial cable to your CariboSystem machine and Linux machine.
; Start CariboSystem and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the CariboSystem machine, you will see a
...
erase_sub:
	...
	start_msg	db 'Caribo minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting Caribo minicom; press a key to return to CariboSystem', 13, 10, 0
