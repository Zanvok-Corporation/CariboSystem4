rem *** CariboSystem BASIC demo ***

cls

$1 = "Hex dumper,CariboTron"
...
if a = 2 then goto runcaribotron
...
rem CariboTron Game (CARIBOTRON.BAS)
rem A expanded demo game
rem Zanvok Corporation
rem Version 5.0.2
rem Send any bug reports or suggested features to:
rem zanvokcorporation@gmail.com
