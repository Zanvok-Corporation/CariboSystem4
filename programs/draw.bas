rem ASCII Artist, version 5.6.7 (DRAW.BAS)
rem A text drawing program for CariboSystem
rem Copyright (C) Zanvok Corporation 2022
rem Licenced under the GNU General Public Licence, see licence.txt

rem Requires the GAU++ library, version 4.0 or later
include "gaupp.bas"
...
help_about:
  ...
  $6 = $6 + "Copyright (C) Zanvok Corporation 2022|"
  $6 = $6 + "Email: zanvokcorporation@gmail.com|\7"
       $7 = "Licenced under the GNU GPL v3|"
  $7 = $7 + "Uses the GAU++ library, version 4.0+"
  gosub mesbox
return
