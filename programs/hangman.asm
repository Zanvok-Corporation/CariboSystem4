; ------------------------------------------------------------------
; Geography-based hangman game for CariboSystem
;
; At the end of this file you'll see a list of cities (in
