REM >>>GAU-PLUS-PLUS-LIBRARY<<<
REM Library Version 4.7.9.120+
REM Copyright (C) Zanvok Corporation.
REM Licenced under the GNU General Public Licence revision 3.
REM Requires CariboOS version 4.1 or later.


PRINT "GAU++ Library version 4.7.9.120+"
END
